...
public class CameraHolder {
    ...
    // Use a singleton.
    private static edu.dhbw.andar.CameraHolder sHolder;
    public static synchronized edu.dhbw.andar.CameraHolder instance() {
        if (sHolder == null) {
            sHolder = new edu.dhbw.andar.CameraHolder();
        }
        return sHolder;
    }
